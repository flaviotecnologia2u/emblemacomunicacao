  ...
  <div class="container_12"><div class="ic"></div>
    ...
    <div class="grid_9">
      <div class="serv_links">
        <span class="serv">Web</span>
        <span class="serv">Programação</span>
        <span class="serv">SEO</span>
        <span class="serv">SEM</span>
        <span class="serv">Gráfico</span>
        <span class="serv">Ideais</span>
        <span class="serv">Gestão</span>
        <span class="serv">Planejamento</span>
      </div>
    </div>
    <div class="grid_3 fwn">
      <div class="text1">Nos diga o que você precisa que nós faremos o melhor trabalho que você já viu!</div>
      Entre em contato <strong><a href="#contato" rel="nofollow">aqui</a></strong><br><br> 
      <strong> Emblema Comunicação & Marketing</strong>
    </div>
      <div class="clear"></div>
  </div>
</section>
...
<section id="emblema" class="page">
  <div class="about_inset__1">
    <div class="container_12">
      <div class="grid_12">
    
        <h3 class="head__1">Sobre</h3>
      
        <div class="empresa">
          
          <?
           	$sqlempresa = mysql_query("SELECT content FROM page WHERE id='34' ");
           		while ($em = mysql_fetch_array($sqlempresa)) {
           			$empresa = $em[content];
           		}
        ...
        <h3 class="head__1">Workflow</h3>
        <div class="story">
          <div class="grid_6 alpha">
            <div class="block-1">
              <time datetime="2014-01-01" class="cornered">Projeto</time>
              <div class="extra_wrapper">
                <div class="text1 tx__1"><a href="#">Reunião</a></div>
                Criamos o briefing de acordo com as especificações do cliente.
              </div>
            </div>
            <div class="block-1">
              <time datetime="2014-01-01" class="cornered">Análise</time>
              <div class="extra_wrapper">
                <div class="text1 tx__1"><a href="#">Análise do processo</a></div>
                Estudamos o projeto passo a passo e decidimos a melhor estratégia.
              </div>
            </div>
          </div>
          <div class="grid_6 omega">
            <div class="block-1 inset__1">
              <time datetime="2014-01-01" class="cornered">Design</time>
              <div class="extra_wrapper">
                <div class="text1 tx__1"><a href="#">Decisão do Design</a></div>
                Experimentamos vários tipos de design e escolhemos o que mais se adequa a sua necessidade.
              </div>
            </div>
          </div>
          <div class="clear"></div>
        
          <div class="cornered pos__1">Entrega <br> do projeto</div>
        </div>
      <div class="clear"></div>
